package com.dimple.common.core.controller;

import com.dimple.common.core.domain.AjaxResult;
import com.dimple.common.core.domain.AjaxResult.Type;
import com.dimple.common.core.page.PageDomain;
import com.dimple.common.core.page.TableDataInfo;
import com.dimple.common.core.page.TableSupport;
...
public class BaseController {
    ...
    protected void startPageNoOrderBy() {
        PageDomain pageDomain = TableSupport.buildPageRequest();
        Integer pageNum = pageDomain.getPageNum();
        Integer pageSize = pageDomain.getPageSize();
        if (StringUtils.isNotNull(pageNum) && StringUtils.isNotNull(pageSize)) {
